...
ATHENA_OUTPUT_BUCKET = "s3://athena-sales-analysis-new/output_from_lambda/"  # S3 bucket where Athena will put the results, e.g., "s3://sales-data-analysis-gds/output/"
DATABASE = 'athena_db'  # The name of the database in Athena
